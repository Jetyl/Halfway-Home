...
namespace Stratus
{
  namespace Utilities
  {
    public static partial class Reflection
    {
      ...
      {
        //public enum MemberContainingType { Property, Field }
        /// <summary>
        ...
        /// </summary>
        public Type Type;
        //public MemberContainingType ContainingType;
        /// <summary>
        ...
        public string Value
        {
          get
          {
            ...
            // Maybe throw instead
            throw new ArgumentNullException("No valid field or property were set!");
          }
        }
      ...
      public static VariableReference GetReference<T>(Expression<Func<T>> varExpr)
      {
        ...
        variableReference.Name = variableName;
