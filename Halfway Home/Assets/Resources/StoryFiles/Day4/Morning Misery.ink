...
=== Start ===
Its a rather sunny morning, and I decide to head into the art room to do some painting, or what have you. # play : play_music_silly
	...
	-else:
		...
		[{player_name}] "Sure..."
		{
			...
			-GetValue("FoundLateNightHangout"):
				Yeah, I didn't feel like going. Wonder if there was anything else?
			-week >=2 :
				So that's where Eduardo and Isaac were late Tuesday night/Wednesday morning. 
...
Oh dear, Eduardo appears to be having a gushing fit over his boyfriend.
...
+[Say nothing]
	I decide not to challenge his view on his own relationship.
	->Gushing
+[Disagree]
	->Pulling
...
His excessive passion is very inspiring and my skills in <color=color_expression>expression</color> increase considerably, but it <color=color_wellbeing_penalty>significantly tires you out</color>. #expression++ #fatigue += 20
...
===Pulling===
{
	...
	-else:
		...
		He notices the serious tone of your voice.
...
===Disbelief===
[Eduardo] "Right..."
Sensing the awkwardness and your failure to convince Eduardo of anything, you silently leave the room.
->END
