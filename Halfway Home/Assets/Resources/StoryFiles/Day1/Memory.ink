...
=== Start ===
//~week = 1
This is it. Sunflower House. # Background / HouseFront # Ambience : play_ambience_birds # All * Hide # 0 & InProgress # 0.0 & Success # 0.1 & InProgress # 0.2 & Failed # 0.3 & InProgress # 0.4 & InProgress
It's a Halfway House: a place meant to help people like me `<flow>transition back into the community</flow>`.
`<jitter>A Garden for the Mind</jitter>` according to the brochure the doctors gave me.
Pretty cheesy, but they said I don't really stand much chance in the real world. <pulse>Maybe they're right</pulse>.
