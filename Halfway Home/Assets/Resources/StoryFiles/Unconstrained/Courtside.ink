...
Guess I'm committed to it now. # Timothy = Calm
...
As if on cue, Max appears, seemingly from out of nowhere. # Max = Happy
[Max] "Heads up!"
Max lobs a large ball at my chest and my hands instinctively raise to catch it.
[{player_name}] "Oof!"
...
I can't think of a victory phrase associated with the game. More... loud noises.
...
This shot shouldn't be too hard. I arc the ball toward my goal...
{shuffle:
...
=PlayerTestMedium
He recovers the ball and passes it to me.
I'm not certain I can make this one, but it doesn't look <i>too</i> bad. I arc the ball toward my goal...
{shuffle:
	-It's a perfect recreation!
		->GameTime.TimothyTurn
	-And it's in! I grab the ball and pass it back to Timothy. He'll have to do better than that!
...
=PlayerTestHard
He recovers the ball and passes it to me.
Oof. That was actually a really good shot. This one might be tough. I arc the ball toward my goal...
{shuffle:
...
[{player_name}] "Some do, but there's no time limit except what's recommended by your doctor or whoever. I remember Max explaining that Sunflower House moves slower than other places, but not why."
"I think it was something about not pressuring residents."
...
[Timothy] "Oh! Oh no! I didn't mean! I-" # Timothy = Afraid
"I just mean that you're so cool, you know? Like nothing bothers you."
...
[{player_name}] "Wow. Uh, thanks, Timothy. That's actually the nicest thing anyone's said about me in a while."
