...
public class TimeNode : BaseNode
{
    ...
    public override void Draw()
    {
        ...
        outPoint.Draw();
        GUI.Box(rect, "", style);
        EditorGUI.LabelField(new Rect(rect.position + new Vector2(25, 15), new Vector2(150, 20)), "Time Action Node");
        ...
        EditorGUI.LabelField(new Rect(rect.position + new Vector2(25, 110), new Vector2(275, 20)), "Perform actions at " + GetTime(Hour) + " On Day " + Day);
